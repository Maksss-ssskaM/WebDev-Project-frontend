...
const Home = () => {
    ...
    const popularAssets: any[] = useAppSelector(state => state.assets.popularAssets)
    const filteredArray = popularAssets.filter((value, index, self) => index === self.findIndex((t) => t.name === value.name))
